...
class Sekai {
     ...
     **/
     postStats(guildCount, shardCount) {
         ...
         if (typeof guildCount !== 'number') return new TypeError('guildCount is not a string');
         if (typeof shardCount !== 'number') return new TypeError('shardCount is not a string');
